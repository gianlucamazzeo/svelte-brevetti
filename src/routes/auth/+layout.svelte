...
>
	<div class="w-full max-w-md overflow-hidden rounded-lg bg-white shadow-md">
		...
		<div class="bg-blue-600 p-6 text-center text-white">
			...
			<h1 class="text-2xl font-bold">UfficioBrevetti</h1>
			<p class="mt-1 text-sm opacity-90">Gestione Brevetti e Marchi</p>
		</div>
		...
		<!-- Footer -->
		<div class="border-t border-gray-100 p-3 text-center text-xs text-gray-500">
